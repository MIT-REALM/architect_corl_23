...
CUDA_VISIBLE_DEVICES=0, XLA_PYTHON_CLIENT_MEM_FRACTION=0.2 python architect/experiments/drone_landing/predict_and_mitigate.py --model_path tmp/oracle_32/policy_50.eqx --num_rounds 100 --num_steps_per_round 10 --num_chains 10 --T 60 --ep_mcmc_step_size 1e-3 --dp_mcmc_step_size 1e-3 --num_trees 10 --disable_gradients --disable_stochasticity --savename drone_landing &
