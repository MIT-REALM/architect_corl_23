"""Train an agent for the drone environment using PPO."""
import os
...
def train_ppo_drone(
    ...
    seed: int = 0,
    steps_per_epoch: int = 32 * 10,
    epochs: int = 200,
    gd_steps_per_update: int = 50,
    minibatch_size: int = 32,
    max_grad_norm: float = 10.0,
    logdir: str = "./tmp/drone_nonorm_xcap_goal_10",
):
    """
    Train the drone using PPO.
    ...
    for epoch in range(epochs):
        ...
        print(
            (
                ...
                f"mean_reward: {trajectory.rewards.mean():.2f} "
                f"mean_return: {trajectory.returns.mean():.2f} "
