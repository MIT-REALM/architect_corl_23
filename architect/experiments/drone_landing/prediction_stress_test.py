...
SUMMARY_PATH = (
    "results/drone_landing_smooth/predict_repair/coverage_summary_seed_0.json"
)
...
def monte_carlo_test(N, batches, loaded_data, seed):
...
if __name__ == "__main__":
    ...
    if REANALYZE or not os.path.exists(SUMMARY_PATH):
        ...
        # Compute costs (Change seed no. for different seeds)
        monte_carlo_costs = monte_carlo_test(N, BATCHES, data, 0)
