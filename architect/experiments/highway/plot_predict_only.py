...
if __name__ == "__main__":
    ...
    axs = fig.subplot_mosaic(
        [
            [
                "ego_initial_states",
                "non_ego_1_initial_states",
                "non_ego_2_initial_states",
            ],
    ...
    axs["non_ego_1_initial_states"].plot(
        difference[:, 0], label=["x", "y", "theta", "v"]
    )
    axs["non_ego_1_initial_states"].set_title("Non-ego 1 (closer)")
    axs["non_ego_1_initial_states"].legend()

    axs["non_ego_2_initial_states"].plot(
        difference[:, 1], label=["x", "y", "theta", "v"]
    )
