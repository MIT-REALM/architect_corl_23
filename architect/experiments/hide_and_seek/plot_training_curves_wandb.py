...
path = "results/hide_and_seek_disturbance/12v20.csv"
...
if __name__ == "__main__":
    ...
    # Filter to only plot 50 rounds
    rounds_to_plot = 50
    results = results[results.index <= rounds_to_plot]
    ...
    plt.savefig("hide_and_seek_12_20.png")
